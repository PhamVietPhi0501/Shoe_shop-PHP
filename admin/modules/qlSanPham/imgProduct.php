<?php
    ...
    if(isset($_POST['themsanpham'])){
        ...
        $sql_them = "UPDATE tbl_img_product SET img2='".$hinhanh2_time."',img3='".$hinhanh3_time."',img4='".$hinhanh4_time."',img5='".$hinhanh5_time."',img6='".$hinhanh6_time."' WHERE id_sanpham='$msp' ";
        mysqli_query($mysqli,$sql_them);
        move_uploaded_file($hinhanh2_tmp,'uploads/'.$hinhanh2_time);
        move_uploaded_file($hinhanh3_tmp,'uploads/'.$hinhanh3_time);
        move_uploaded_file($hinhanh4_tmp,'uploads/'.$hinhanh4_time);
        move_uploaded_file($hinhanh5_tmp,'uploads/'.$hinhanh5_time);
        move_uploaded_file($hinhanh6_tmp,'uploads/'.$hinhanh6_time);
